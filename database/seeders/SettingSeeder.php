...
class SettingSeeder extends Seeder
{
    ...
    public function run()
    {
        Setting::insert([
            ...
            ['option_key' => 'PAYSTACK_PUBLIC_KEY', 'option_value' => 'pk_test_5a793af5d4bd9a6997dd77170f8944475c7bdb6b', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'PAYSTACK_SECRET_KEY', 'option_value' => 'sk_test_d42d5016cb7e3ebb9f588adf94a2797b82afda0b', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['option_key' => 'paypal_status', 'option_value' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'PAYPAL_MODE', 'option_value' => 'sandbox', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'PAYPAL_CLIENT_ID', 'option_value' => 'Aa1fK4Au7IDzctR2B89DbBAkrlZ66WoFwichF0pdFUkQokPXDpDL0ccKL4l_WNPKjkS3eE_-76SZwdPL', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'PAYPAL_SECRET', 'option_value' => 'EE9qz8LFWuM-I6llDXLy4w37XEUm77OWBReUxOl7WbQ_YVBGOVJ4ZiPucCtTJJTxYS_aY8CTWlpkiRkN', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['option_key' => 'stripe_status', 'option_value' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'STRIPE_MODE', 'option_value' => 'sandbox', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'STRIPE_SECRET_KEY', 'option_value' => 'pk_test_51L2rx4EHJUnjcXlDecNX4E669VSemwZuozJQZ8VDuPti38brbfdgqG8TpJglVmUm14Fa99BTVWlo2slPhicSm5nc00WGcsGHx4', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'STRIPE_PUBLIC_KEY', 'option_value' => 'sk_test_51L2rx4EHJUnjcXlD7OJuzYjwqNdEkoHfowhPgBggxOwuUlVGCROXV704Ksm79fXTFyFJxBBf1kgXlrosuDHubYUL00F9wvoudd', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['option_key' => 'MOLLIE_KEY', 'option_value' => 'test_2JgWy4brVTeaU8yRCHj4ubyjMwBrBT', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['option_key' => 'IM_API_KEY', 'option_value' => 'test_66613099e481c99e98001ed6c6b', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'IM_AUTH_TOKEN', 'option_value' => 'test_027e84686ee7e09e60edee68a6b', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['option_key' => 'sslcommerz_status', 'option_value' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'sslcommerz_mode', 'option_value' => 'sandbox', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'SSLCZ_STORE_ID', 'option_value' => 'zaini628c826e8b784', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'SSLCZ_STORE_PASSWD', 'option_value' => 'zaini628c826e8b784@ssl', 'created_at' => now(), 'updated_at' => now()],

            ['option_key' => 'MAIL_DRIVER', 'option_value' => 'smtp', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_HOST', 'option_value' => 'mail.zainiklab.com', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_PORT', 'option_value' => '465', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_USERNAME', 'option_value' => 'lmszai@zainiklab.com', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_PASSWORD', 'option_value' => "&9r(K@BOu,&,", 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_ENCRYPTION', 'option_value' => 'ssl', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_FROM_ADDRESS', 'option_value' => 'lmszai@zainiklab.com', 'created_at' => now(), 'updated_at' => now()],
            ['option_key' => 'MAIL_FROM_NAME', 'option_value' => 'Zainik Theme', 'created_at' => now(), 'updated_at' => now()],
