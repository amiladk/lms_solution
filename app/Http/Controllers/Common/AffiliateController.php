...
class AffiliateController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $affiliate = AffiliateHistory::where(['user_id'=> Auth::id(), 'status' => AFFILIATE_HISTORY_STATUS_PAID])->sum('actual_price');
        $earnings = AffiliateHistory::where(['user_id'=> Auth::id(), 'status' => AFFILIATE_HISTORY_STATUS_PAID])->sum('commission');
        $count = AffiliateHistory::where(['user_id'=> Auth::id(), 'status' => AFFILIATE_HISTORY_STATUS_PAID])->count();
